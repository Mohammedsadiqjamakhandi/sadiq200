...
) if SEND_TELEGRAM else None

# ✅ Telegram test
send_telegram("✅ Live strategy started. Tracking NSE 200 stocks...")
...
def build_candle(symbol, ltp):
    ...
    if not c or c[-1]["minute"] != minute:
        ...
        print(f"🕯️ {symbol} - New candle: {minute} | O:{ltp}")
...
def check_signal(symbol):
    ...
    # No signal match
    print(f"🔍 {symbol} - No signal at {c3['minute']}")
