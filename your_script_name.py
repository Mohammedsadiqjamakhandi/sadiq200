...
def check_signal(symbol):
    df = symbol_data[symbol]
    if len(df) < 5:  # Shorter than before to start signals early
        return
...
# Hardcoded large-cap symbols with correct tokens (example tokens; please replace with your verified tokens)
symbol_token_map = {
    "RELIANCE-EQ": "2885",
    "HDFCBANK-EQ": "341249",
    "INFY-EQ": "408065",
...
print(f"📡 Tracking {len(symbol_token_map)} large-cap stocks...")
